...
(function (factory) {
    ...
    /*
     ...
     Use ajaxForm when you want the cert to manage all the event binding
     for you.  For example,
    ...
    $.fn.ajaxForm = function (options) {
        ...
        if (options.delegation) {
            $(document).off('submit.form-cert', this.selector, doAjaxSubmit).off('click.form-cert', this.selector, captureSubmittingElement).on('submit.form-cert', this.selector, options, doAjaxSubmit).on('click.form-cert', this.selector, options, captureSubmittingElement);
            return this;
        }

        return this.ajaxFormUnbind().on('submit.form-cert', options, doAjaxSubmit).on('click.form-cert', options, captureSubmittingElement);
    };
    ...
    $.fn.ajaxFormUnbind = function () {
        return this.unbind('submit.form-cert click.form-cert');
    };
 ...
 * Lazy Load - jQuery cert for lazy loading images
 ...
 * Powerful jQuery and Zepto cert for checkboxes and radio buttons customization
 *
 ...
 * -------------------------------------------------------------------
 * jQuery Raty is a cert that generates a customizable star rating.
 ...
 * ========================================================================*/
!function ($) {
    $.Huimodalalert = function (info, speed, callback) {
        ...
        if (speed == 0 || typeof(speed) == "undefined") {
            ...
            $("#modal-alert").fadeIn();
            setTimeout(function () {
                $.Huimodalalert.hide(callback);
            }, speed);
        }
    }
    $.Huimodalalert.hide = function (callback) {
    ...
    function ($) {
        ...
        (function ($) {
            ...
            function defineBridget($) {
                ...
                // -------------------------- addOptionMethod -------------------------- //
                /**
                 * adds option method -> $().cert('option', {...})
                ...
                /**
                 * jQuery cert bridge, access methods like $elem.cert('method')
                 * @param {String} namespace - cert name
                 * @param {Function} PluginClass - constructor class
                 */
                function bridge(namespace, PluginClass) {
                    ...
                    $.fn[namespace] = function (options) {
                        if (typeof options === 'string') {
                            // call cert method when first argument is a string
                ...
                // -------------------------- bridget -------------------------- //
                /**
                 * converts a Prototypical class into a proper jQuery cert
                 *   the class must have a ._init method
                 * @param {String} namespace - cert name, used in $().pluginName
                 * @param {Function} PluginClass - constructor class
                 */
        ...
        (function ($) {
            ...
            /*************************************************
             ...
             part of the cert's `public` interface
             **************************************************/
            Slider.prototype = {
                _init: function () {
                },
...
!(function (factory) {
    ...
    var Datetimepicker = function (element, options) {
        ...
        if (this.wheelViewModeNavigation) {
            if ($.fn.mousewheel) {
                ...
                console.log('Mouse Wheel event is not supported. Please include the jQuery Mouse Wheel cert before enabling this option');
            }
        }
    ...
    Datetimepicker.prototype = {
        ...
        _attachEvents: function () {
            ...
            } else if (this.component && this.hasInput) { // extend: input + button
                this._events = [
    ...
    $(document).on('focus.datetimepicker.data-api click.datetimepicker.data-api', '[data-provide="datetimepicker"]',
        function (e) {
            ...
            e.preventDefault();
            // extend click requires us to explicitly show it
